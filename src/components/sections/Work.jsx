...
export default function Work({ onProjectClick }) {
  ...
  return (
    <section id="work" ref={targetRef} className="relative h-[380vh] bg-[#F2EFE7]">

      {/* ── Sticky Pinned Viewport Container ────────────────────────────── */}
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center px-6 md:px-14">

        {/* ── Section Title & Progress Bar ───────────────────────────────── */}
        <div className="max-w-7xl mx-auto w-full mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4 select-none pb-4 border-b border-[#111318]/15">
          <div>
          ...
          <div className="flex items-center gap-4">
            <span className="font-mono text-xs text-[#4B5162] font-bold">
              04 DRAWINGS + ARCHIVE
            </span>
            <div className="w-32 sm:w-48 h-2 bg-[#E1DCCE] border border-[#111318] overflow-hidden">
              <motion.div
        ...
        <div className="w-full flex items-center overflow-visible">
          ...
          >
            {featured.map((proj, idx) => (
              <div
                key={proj.id}
                className="w-[85vw] sm:w-[720px] lg:w-[860px] h-[480px] lg:h-[510px] flex-none sheet-frame overflow-hidden shadow-lg"
              >
                <div className="h-full flex flex-col justify-between">

                  {/* Top Title Strip */}
                  <div className="flex items-center justify-between px-6 py-2.5 border-b border-[#111318]/15 bg-[#E1DCCE]">
                    <div className="flex items-center gap-3">
                      <span className="font-mono font-bold text-xs text-[#FF4400]">
                        DWG-00{idx + 1}
                      </span>
                      <span className="font-mono text-[0.68rem] text-[#4B5162] hidden sm:inline">
                  ...
                  <div className="flex-1 grid lg:grid-cols-[1.15fr_1fr] min-h-0">
                    ...
                    <div className="p-6 sm:p-8 flex flex-col justify-between overflow-hidden">
                      <div>
                        ...
                        <h3 className="font-display font-black text-2xl sm:text-3xl text-[#111318] tracking-tight uppercase">
                          {proj.title}
                        </h3>
                        ...
                        <p className="text-[#4B5162] text-sm leading-relaxed mt-3 line-clamp-3 font-body">
                          {proj.description}
                        </p>
                      ...
                      {/* CTAs */}
                      <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-[#111318]/15">
                        <button
                    ...
                    <div className="relative h-full w-full hidden lg:block border-l border-[#111318]/15 overflow-hidden bg-[#E1DCCE] group">
                      <img
                        src={proj.img}
                        alt={proj.title}
                        loading="lazy"
                      ...
                      />
                      <div className="absolute bottom-3 right-3 px-2 py-1 bg-[#F2EFE7] border border-[#111318] font-mono text-[0.62rem] font-bold text-[#111318]">
                  ...
                  {/* Bottom Footer Strip */}
                  <div className="hidden sm:flex items-center justify-between px-6 py-1.5 border-t border-[#111318]/15 bg-[#EAE6DC] font-mono text-[0.62rem] text-[#8A91A5]">
            ...
            <div className="w-[85vw] sm:w-[520px] h-[480px] lg:h-[510px] flex-none sheet-frame p-8 sm:p-12 text-center shadow-lg flex flex-col items-center justify-center bg-[#EAE6DC]">
              <span className="bp-stamp text-[#FF4400] border-[#FF4400]">
                ARCHIVE // COMPLETE INDEX
              </span>
              <h3 className="font-display font-black text-3xl sm:text-4xl text-[#111318] mt-3 uppercase">
                ALL {PROJECTS_DATA.length} BLUEPRINTS.
              </h3>
              <p className="text-[#4B5162] text-sm max-w-sm mt-3 leading-relaxed font-body">
