...
export const PROJECTS_DATA = [
  {
    ...
    status: 'Shipped',
    description:
      'A production-grade e-commerce platform built with Flutter, featuring real-time inventory management, Firebase Authentication, Cloud Firestore database, and Bloc/Cubit state management. Follows strict Clean Architecture principles with a Repository pattern, ensuring the codebase is maintainable and testable.',
    tech: ['Flutter', 'Dart', 'Firebase Auth', 'Cloud Firestore', 'Bloc/Cubit', 'Clean Architecture', 'REST APIs', 'Figma'],
    features: ['User auth & profile management', 'Product catalog with search & filters', 'Real-time cart & order flow', 'Admin dashboard for inventory', 'Push notifications'],
