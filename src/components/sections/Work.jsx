...
export default function Work({ onProjectClick }) {
  ...
  // Smooth horizontal translation for desktop pinned scroll
  ...
  return (
    <div id="work" className="relative">
      ...
      {/* ── MOBILE VIEW: Native Horizontal Touch Scroll (md:hidden) ──────── */}
      <section className="block md:hidden py-8 px-3 overflow-hidden">
        ...
        <div className="w-full overflow-x-auto flex items-center gap-3.5 pl-1 pr-6 pb-3 pt-1 snap-x snap-mandatory scroll-smooth no-scrollbar touch-pan-x">
          {featured.map((proj, idx) => (
            <div
              key={`m-${proj.id}`}
              className="w-[86vw] max-w-[400px] h-[520px] flex-none snap-center"
            >
              <div className="h-full sheet-frame overflow-hidden shadow-xl flex flex-col justify-between border border-current/20 bg-inherit">
                ...
                <div className="p-4 flex flex-col justify-between flex-1 overflow-hidden">
                  ...
                  {/* Action Buttons */}
                  <div className="grid grid-cols-2 gap-2 pt-3 border-t border-current/15 mt-2">
                    <button
                      onClick={() => { playSwitchClick(); onProjectClick(proj); }}
          ...
          <div className="w-[86vw] max-w-[400px] h-[520px] flex-none snap-center">
            <div className="h-full sheet-frame p-6 text-center shadow-xl flex flex-col items-center justify-center border border-current/20 bg-inherit">
      ...
      {/* ── DESKTOP VIEW: 100% Exact 460vh Pinned Reel (hidden md:block) ── */}
